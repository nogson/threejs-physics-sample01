...
`)a=0,c-=s;else{const d=GM(h,i,a,c,t);a+=d.offsetX,o.push(d.path)}}return o}function GM(r,e,t,n,i){const s=i.glyphs[r]||i.glyphs["?"];if(!s){console.error('THREE.Font: character "'+r+'" does not exists in font family '+i.familyName+".");return}const o=new Wp;let a,c,l,h,d,u,f,m;if(s.o){const _=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let g=0,p=_.length;g<p;)switch(_[g++]){case"m":a=_[g++]*e+t,c=_[g++]*e+n,o.moveTo(a,c);break;case"l":a=_[g++]*e+t,c=_[g++]*e+n,o.lineTo(a,c);break;case"q":l=_[g++]*e+t,h=_[g++]*e+n,d=_[g++]*e+t,u=_[g++]*e+n,o.quadraticCurveTo(d,u,l,h);break;case"b":l=_[g++]*e+t,h=_[g++]*e+n,d=_[g++]*e+t,u=_[g++]*e+n,f=_[g++]*e+t,m=_[g++]*e+n,o.bezierCurveTo(d,u,f,m,l,h);break}}return{offsetX:s.ha*e,path:o}}class WM extends fc{constructor(e,t={}){const n=t.font;if(n===void 0)super();else{const i=n.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(i,t)}this.type="TextGeometry"}}const XM="/threejs-physics-sample01/",qM=window.location.origin,er=`${qM}${XM}`;console.log(er);const Mh=[16772736,16722918,16722734,2829311,2883371];function oo(r){const e=new rM;return new Promise(t=>{e.load(r,n=>{t(n)},void 0,n=>{console.error(n)})})}function YM(r){const e=new kM;return new Promise((t,n)=>{e.load(r,i=>t(i),void 0,i=>n(i))})}function vn(r){const e=new yn().setFromObject(r),t=new U;return e.getSize(t),t}async function jM(){const r=await oo(`${er}glb/motorcycle.glb`),e=r.scene,n=1/vn(e).y,i=Ri({friction:.5,restitution:.1});e.traverse(h=>{h instanceof _t&&(h.castShadow=!0,h.receiveShadow=!0)}),e.scale.set(n,n,n);const s=vn(e),o=new Gp(e);r.animations.forEach(h=>{o.clipAction(h).play()});const c=new si(new S(s.x/2,s.y/2,s.z/2)),l=new ge({mass:50,position:new S(0,s.y/2,0),shape:c,material:i.material});return l.name="mainCharacter",{mesh:e,body:l,mixer:o}}const KM=r=>{const e=new Ix,t=new ge({mass:0,shape:e,material:r});t.quaternion.setFromAxisAngle(new S(-1,0,0),Math.PI*.5);const n=new _t(new Ks(50,50),new wi({metalness:.3,roughness:.4,color:9437090}));return n.receiveShadow=!0,n.rotation.x=-Math.PI*.5,{mesh:n,body:t}};function ta({position:r,size:e,bodyMaterial:t}){const n=new si(new S(e.x/2,e.y/2,e.z/2)),i=new ge({mass:1,position:new S(r.x,r.y,r.z),shape:n,material:t}),s=new gs(e.x,e.y,e.z),o=new wi({color:16772736,metalness:.3,roughness:.4}),a=new _t(s,o);return a.castShadow=!0,a.receiveShadow=!0,a.position.copy(i.position),{mesh:a,body:i}}function ZM({scene:r,world:e}){const t=Ri({friction:.5,restitution:2}),n=[];for(let i=0;i<5;i++){const o=i%5*.5,a=Math.floor(i/5)/2+.5/2,c=ta({size:new U(.5/2,.5,.5),position:new U(3,a,o),bodyMaterial:t.material});n.push(c),e.addBody(c.body),r.add(c.mesh)}for(let i=0;i<16;i++){const a=Math.floor(i/8)*.5+.25,c=i%8*.5-4,l=ta({size:new U((2-Math.floor(i/8))*.5/2,.5,.5),position:new U(-7,a,c),bodyMaterial:t.material});n.push(l),e.addBody(l.body),r.add(l.mesh)}for(let i=0;i<10;i++){const o=i%5*.5,a=Math.floor(i/5)/2+.5/2,c=ta({size:new U(.5,.5,.5/2),position:new U(o,a,5),bodyMaterial:t.material});n.push(c),e.addBody(c.body),r.add(c.mesh)}return n}function $M({position:r}){const e=Mh[Math.floor(Math.random()*Mh.length)],t=Math.random()*.3+.05,n=new pc(t,32,32),i=new wi({color:e,metalness:.3,roughness:.4}),s=new _t(n,i);s.castShadow=!0,s.receiveShadow=!0;const o=Ri({friction:.1,restitution:.5}),a=new Cx(t),c=new ge({mass:1,shape:a,material:o.material,position:r});return{mesh:s,body:c}}function JM({scene:r,world:e}){const t=[];for(let n=0;n<20;n++){const i=new S(ms(),.5,ms()),s=$M({scene:r,world:e,position:i});t.push(s),r.add(s.mesh),e.addBody(s.body)}return t}function QM({bodyMaterial:r,mesh:e,position:t}){const n=new Px(.2,.2,1,32),i=new ge({mass:1,shape:n,material:r,position:t});return i.isActive=!0,e.position.copy(i.position),{mesh:e,body:i}}function ms(){const r=Math.random()*30-15;return r>0?r+2:r-2}async function eS({scene:r,world:e}){const t=[],n=Ri({friction:10,restitution:1}),i=await oo(`${er}glb/point.glb`),s=10;for(let o=0;o<s;o++){const a=i.scene.clone(),c=vn(a),l=1/c.y;a.traverse(u=>{u instanceof _t&&(u.castShadow=!0,u.receiveShadow=!0)}),a.scale.set(l,l,l);const h=new S(ms(),c.y/2,ms()),d=QM({bodyMaterial:n.material,position:h,mesh:a});d.body.name="point"+o,e.addBody(d.body),r.add(d.mesh),t.push(d)}return t}async function tS({scene:r,world:e}){const n=[],i=await oo(`${er}glb/tree.glb`),s=i.scene,o=vn(s),a=Ri({friction:1.5,restitution:.1});for(let c=0;c<10;c++){const l=i.scene.clone(),h=(Math.random()*2+1)/o.y;l.traverse(m=>{m instanceof _t&&(m.castShadow=!0,m.receiveShadow=!0)}),l.scale.set(h,h,h);const d=vn(l),u=new si(new S(d.x/2,d.y/2,d.z/2)),f=new ge({mass:0,position:new S(ms(),d.y/2,ms()),shape:u,material:a.material});f.quaternion.setFromAxisAngle(new S(0,-1,0),Math.PI*(Math.random()*4)),r.add(l),e.addBody(f),n.push({mesh:l,body:f})}return n}async function Sh({scene:r,world:e,text:t,position:n}){const i=t.split(""),s=await YM("https://threejs.org/examples/fonts/helvetiker_regular.typeface.json"),o=[],a=[],c=.5;return i.forEach(l=>{const h=new WM(l,{font:s,size:c,height:.2,curveSegments:12,bevelEnabled:!0,bevelThickness:.03,bevelSize:.02,bevelOffset:0,bevelSegments:5});h.computeBoundingBox();const d=h.boundingBox,u=new U;d==null||d.getCenter(u),h.translate(-u.x,-u.y,-u.z);const f=new wi({color:16777215}),m=new _t(h,f);m.castShadow=!0,m.receiveShadow=!0,o.push(m)}),o.forEach((l,h)=>{const d=o[h-1],u=new si(new S(c/2,c/2,.1)),f=new ge({mass:1,shape:u});if(d){const m=vn(d);f.position.copy(new S(d.position.x+m.x/2+vn(l).x/2+.4,m.y/2,n.z))}else{const m=vn(l);f.position.copy(new S(n.x,m.y/2,n.z))}l.position.copy(f.position),e.addBody(f),r.add(l),a.push({mesh:l,body:f})}),a}async function nS({scene:r,world:e}){const t=[],i=(await oo(`${er}glb/car.glb`)).scene,s=vn(i),o=Ri({friction:1.5,restitution:.1}),a=1/s.y;i.traverse(d=>{d instanceof _t&&(d.castShadow=!0,d.receiveShadow=!0)}),i.scale.set(a,a,a);const c=vn(i),l=new si(new S(c.x/2,c.y/2,c.z/2)),h=new ge({mass:0,position:new S(-2,c.y/2,-5),shape:l,material:o.material});return h.quaternion.setFromAxisAngle(new S(0,1,0),Math.PI/2),r.add(i),e.addBody(h),t.push({mesh:i,body:h}),t}function iS(){const r=new Ky;r.gravity.set(0,-9.82,0),r.broadphase=new xu;const e=r.solver;return e.iterations=30,e.tolerance=.01,r}function sS(r){const e=new Ap(16777215,.5);r.add(e);const t=new du(16777215,3);t.castShadow=!0,t.shadow.mapSize=new ue(1024,1024),t.shadow.camera.left=-30,t.shadow.camera.right=30,t.shadow.camera.top=30,t.shadow.camera.bottom=-30,t.shadow.camera.near=.1,t.shadow.camera.far=50,t.position.set(0,10,0),r.add(t);const n=new uu(16777215,250);return n.position.set(0,8,8),n.castShadow=!0,n.shadow.mapSize=new ue(1024,1024),n.angle=Math.PI/4,n.penumbra=1,n.decay=2,n.distance=200,r.add(n),{ambientLight:e,directionalLight:t,spotLight:n}}class rS{constructor(){Pc(this,"_score",0)}get score(){return this._score}set score(e){this._score=e,this.dispatchChangeEvent("score",e)}dispatchChangeEvent(e,t){const n=new CustomEvent("globalStateChange",{detail:{property:e,value:t}});window.dispatchEvent(n)}}const Cu=new rS,Qr=document.getElementById("gameState");function oS(){Qr&&(Qr.innerHTML=`
          
        `),window.addEventListener("globalStateChange",()=>{aS()})}function aS(){let r=Cu.score;if(Qr){let e="";for(let t=0;t<r;t++)e+='<img src="images/point.png" class="point" />';Qr.innerHTML=e}}(async()=>{oS();const r={width:window.innerWidth,height:window.innerHeight},e={speed:0,radian:0,friction:.98},t=document.querySelector("canvas.webgl"),n=new xf,i=new A0({canvas:t,alpha:!0});i.shadowMap.enabled=!0,i.shadowMap.type=Th,i.setSize(r.width,r.height),i.setPixelRatio(Math.min(window.devicePixelRatio,2)),window.addEventListener("resize",()=>{r.width=window.innerWidth,r.height=window.innerHeight,s(),i.setSize(r.width,r.height),i.setPixelRatio(Math.min(window.devicePixelRatio,2))});function s(){const M=window.innerWidth/window.innerHeight;o.left=10*M/-2,o.right=10*M/2,o.top=10/2,o.bottom=10/-2,o.updateProjectionMatrix()}const o=new so(.1,1e3);s(),n.add(o);const{spotLight:a}=sS(n),c=new dt;n.add(c),a.target=c;const l=iS(),h=Ri();l.addContactMaterial(h.materialContactMaterial);const d=KM(h.material);l.addBody(d.body),n.add(d.mesh);const u=await jM();l.addBody(u.body),n.add(u.mesh);const f=ZM({scene:n,world:l}),m=await tS({scene:n,world:l}),_=JM({scene:n,world:l}),g=await Sh({scene:n,world:l,text:"GO!GO!GO!",position:{x:3,y:1,z:-3}}),p=await Sh({scene:n,world:l,text:"FIGHT!",position:{x:-3,y:1,z:3}}),v=await eS({scene:n,world:l}),y=await nS({scene:n,world:l});window.addEventListener("keydown",T=>R(T)),window.addEventListener("keyup",T=>R(T));const x=new Set;function R(T){u.body.wakeUp(),T.type==="keydown"?x.add(T.code):T.type==="keyup"&&x.delete(T.code),x.has("ArrowUp")&&(e.speed+=.01),x.has("ArrowDown")&&(e.speed-=.01),x.has("Space")&&(u.body.quaternion.x=.1),e.speed!==0&&(x.has("ArrowRight")&&(e.radian=-.05),x.has("ArrowLeft")&&(e.radian=.05))}const w=new Pp;let A=0;const L=()=>{const T=w.getElapsedTime(),M=T-A;A=T,l.step(1/60,M,3),sM({mainCharacter:u,objects:[f,v,m,_,g,p,y],speed:e.speed,radian:e.radian}),e.speed*=e.friction,e.radian*=e.friction*.95,x.size===0&&e.speed<.005&&e.speed>-.005&&(e.speed=0),e.radian<.005&&e.radian>-.005&&(e.radian=0),o.position.x=u.mesh.position.x+5,o.position.y=u.mesh.position.y+5,o.position.z=u.mesh.position.z+5,o.lookAt(u.mesh.position),c.position.copy(u.mesh.position),e.speed!==0&&u.mixer.update(M),mh(u.body,.5)&&(console.log("mainCharacter has tipped over"),document.getElementById("gameOver").setAttribute("class","show")),v.forEach(I=>{mh(I.body,.3)&&I.body.isActive&&(Cu.score+=1,I.body.isActive=!1,console.log("point has tipped over"))}),i.render(n,o),window.requestAnimationFrame(L)};L()})();
